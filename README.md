...
**macOS実験版（未署名・作者未検証）**: [AutoLooper.0.4.2.mac.dmg](https://github.com/YoshimiKudo/AutoLooper/releases/download/v0.4.2-macos-experimental/AutoLooper.0.4.2.mac.dmg)

**macOS実験版 ZIP**: [AutoLooper.0.4.2.mac.zip](https://github.com/YoshimiKudo/AutoLooper/releases/download/v0.4.2-macos-experimental/AutoLooper.0.4.2.mac.zip)
...
- macOS実験版: `0.4.2` / `v0.4.2-macos-experimental`
- Windows版リリース日: `2026-06-03` JST
- macOS実験版リリース日: `2026-06-10` JST
- 種別: ベータ / プレリリース
- 対応環境: Windows
...
AutoLooperはマイク録音機能を使いません。macOS実験版 `0.4.2` では、Electronのメディア権限チェックでマイク/カメラ権限を許可しないようにしています。
...
- macOS experimental build: `0.4.2` / `v0.4.2-macos-experimental`
- Windows release date: `2026-06-03` JST
- macOS experimental release date: `2026-06-10` JST
...
AutoLooper does not use microphone recording. In macOS experimental build `0.4.2`, Electron media permission checks explicitly do not allow microphone/camera permissions.
