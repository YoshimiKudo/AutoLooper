...
**Windows版アプリ本体**: [AutoLooper.0.4.3.exe](https://github.com/YoshimiKudo/AutoLooper/releases/download/v0.4.3-beta/AutoLooper.0.4.3.exe)

**macOS実験版（未署名・作者未検証）**: [AutoLooper.0.4.3.mac.dmg](https://github.com/YoshimiKudo/AutoLooper/releases/download/v0.4.3-macos-experimental/AutoLooper.0.4.3.mac.dmg)

**macOS実験版 ZIP**: [AutoLooper.0.4.3.mac.zip](https://github.com/YoshimiKudo/AutoLooper/releases/download/v0.4.3-macos-experimental/AutoLooper.0.4.3.mac.zip)
...
- Windows版: `0.4.3` / `v0.4.3-beta`
- macOS実験版: `0.4.3` / `v0.4.3-macos-experimental`
- Windows版リリース日: `2026-06-10` JST
...
- Windows build: `0.4.3` / `v0.4.3-beta`
- macOS experimental build: `0.4.3` / `v0.4.3-macos-experimental`
- Windows release date: `2026-06-10` JST
